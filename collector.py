                    ...
                    {'_id': device_entry['_id']},
                    {
                        ...
                        '$push': {
                            'downtime': {
                                ...
                                'to': datetime.now().replace(second=0, microsecond=0)
                            }
                        }
                    }
                )
...
if __name__ == '__main__':
    ...
    sched.add_job(main, trigger='interval', seconds=INTERVAL, next_run_time=datetime.now(), misfire_grace_time=10)  # main thread to query meraki
    sched.start()
